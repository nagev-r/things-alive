...
The first big shift for me was understanding how the canvas API worked to actually lay down strokes in accordance to the mouse actions of the user. 
In a way, I had to think like the program itself and:
